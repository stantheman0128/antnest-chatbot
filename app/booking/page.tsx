      ...
      <div className="min-h-screen bg-amber-50 p-4">
        <div className="max-w-sm mx-auto pt-6">
          ...
          <div className="bg-amber-100 rounded-xl p-4 mb-6">
            ...
            <p className="text-xs text-amber-600">可取貨時間：{selected.startTime.slice(0, 5)}–{selected.endTime.slice(0, 5)}</p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              />
              <p className="text-xs text-amber-500 mt-1">請選擇 {selected.startTime.slice(0, 5)}–{selected.endTime.slice(0, 5)} 之間的時間</p>
            </div>
            ...
            <div>
              <label className="text-sm font-medium text-amber-800 block mb-1">訂單編號（選填）</label>
              <input
                type="text"
